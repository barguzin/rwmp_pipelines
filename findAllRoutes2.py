...
def get_options(args=None):
    ...
    argParser.add_argument("-s", "--source-edges", help="comma separated list of source edge ids", type=str)
    argParser.add_argument("-t", "--target-edges", help="comma separated list of target edge ids", type=str)
    print(args)
